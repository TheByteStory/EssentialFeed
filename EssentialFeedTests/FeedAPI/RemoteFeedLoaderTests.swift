...
class RemoteFeedLoaderTests : XCTestCase
{
    ...
    func test_load_deliversErrorOnClientError(){
        ...
        expect(sut, toCompleteWith: .failure(RemoteFeedLoader.Error.connectivity), when: {let clientError = NSError(domain: "Test", code: 0)
    ...
    
    {
        ...
        sut.load{receivedResult in
            ...
            case let (.success(receivedError as RemoteFeedLoader.Error),.success(expectedError as RemoteFeedLoader.Error)):
